...
SELECT
   {{ dbt.cast("e.encounter_id", api.Column.translate_type("varchar")) }} AS encounter_id
    , e.encounter_start_datetime
    , e.encounter_start_date
    , e.encounter_stop_datetime
    , e.encounter_stop_date
    ,{{ dbt.cast("p.person_id", api.Column.translate_type("varchar")) }} AS person_id
    , {{ dbt.cast("pr.provider_id", api.Column.translate_type("varchar")) }} AS provider_id
    , e.payer_id
    , e.encounter_class
    , e.encounter_code
